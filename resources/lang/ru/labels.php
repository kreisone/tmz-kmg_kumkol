    ...
    'backend'  => [
        'access' => [
            ...
            'materials' => [
                ...
                'table' => [
                    'number' => '№ п/п',
                    'title_material' => 'Наименование материала',
                    'action' => 'Действия',
                ],
            ],
            'group_of_personnel' => [
                'title' => 'Группы персонала',
                'edit' => 'Редактировать группу персонала',
                'add' => 'Добавить группу персонала',
                'table' => [
                    'number' => '№ п/п',
                    'title_group' => 'Наименование группы персонала',
                    'title_shopfloor' => 'Цех',
                    'action' => 'Действия',
                ],
            ],
            ...
            'statistics' => [
                ...
                'table' => [
                    'number' => '#',
                    'title_shopfloor' => 'Цех',
                    'title_group_of_personnel' => 'Группа персонала',
                    'title_worker' => 'Сотрудник',
                    'title_material' => 'Материалы',
                ],
            ],
            'config' => [
                'title' => 'Конфигурации',
